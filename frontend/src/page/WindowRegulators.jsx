...
import { motHeroData, emergencyCtaData, automotiveServicesData, majorServicesData } from "../ServiceData/WindowRegulators";
...
export default function WindowRegulatorsPage() {
  return (
    <>
