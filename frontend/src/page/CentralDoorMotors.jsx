...
import { motHeroData, emergencyCtaData, automotiveServicesData, majorServicesData } from "../ServiceData/central-door-motors";
...
export default function CentralDoorMotorsPage() {
  return (
    <>
