        ...
        <div className="text-center space-y-6 animate-fadeIn">
          ...
          <div className="relative">
            <div className="w-24 h-24 md:w-32 md:h-32 mx-auto">
              ...
              <div className="relative bg-gradient-to-br from-[#317F21] to-green-600 rounded-full w-full h-full flex items-center justify-center shadow-lg">
          ...
          <div className="space-y-3">
            ...
            <p className="text-gray-600 text-sm md:text-base max-w-sm mx-auto px-4">
          ...
          <div className="flex items-center justify-center gap-2">
            <div className="w-2 h-2 md:w-3 md:h-3 bg-[#317F21] rounded-full animate-bounce" style={{ animationDelay: '0s' }}></div>
            <div className="w-2 h-2 md:w-3 md:h-3 bg-[#317F21] rounded-full animate-bounce" style={{ animationDelay: '0.2s' }}></div>
            <div className="w-2 h-2 md:w-3 md:h-3 bg-[#317F21] rounded-full animate-bounce" style={{ animationDelay: '0.4s' }}></div>
          </div>
        </div>
      </div>
    );
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-red-50 via-white to-red-50 p-4">
        <div className="text-center space-y-6 max-w-md animate-fadeIn">
          ...
          <div className="relative">
            <div className="w-24 h-24 md:w-32 md:h-32 mx-auto">
              <div className="relative bg-gradient-to-br from-red-500 to-red-600 rounded-full w-full h-full flex items-center justify-center shadow-lg animate-shake">
        ...
        <div className="text-center space-y-4 animate-slideDown">
          ...
          <div className="space-y-2">
            ...
            <p className="text-gray-700 text-base md:text-lg">
              Thank you, <span className="font-semibold text-green-600">{order.user}</span>! 
              ...
              <div className="space-y-2">
                {order.products.map((item, idx) => (
                  ...
                  >
                    ...
                    <span className="font-bold text-green-600 text-sm md:text-base ml-4">
                      £{item.price}
                    </span>
                  </div>
                ))}
